...
ZELRETCH_MODULE_INFO = {'title': 'Quote Maker', 'icon': '💬', 'category': 'Files & Media', 'description': 'Creates a quote image from a replied Telegram message.', 'developer': 'Siam Chowdhury', 'github': 'https://github.com/ChowdhurySiam', 'telegram': 'https://t.me/Ch0wdhury_Siam'}
