...
ZELRETCH_MODULE_INFO = {'title': 'Chat ID Finder', 'icon': '🆔', 'category': 'Telegram Tools', 'description': 'Shows the current chat identifier and related Telegram IDs.', 'developer': 'Siam Chowdhury', 'github': 'https://github.com/ChowdhurySiam', 'telegram': 'https://t.me/Ch0wdhury_Siam', 'undo': '.undo (reply to the Addon output)'}
