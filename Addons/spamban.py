...
ZELRETCH_MODULE_INFO = {'title': 'Spam Protection Check', 'icon': '🛡️', 'category': 'Telegram Tools', 'description': 'Checks the current account against supported Telegram spam restrictions.', 'developer': 'Siam Chowdhury', 'github': 'https://github.com/ChowdhurySiam', 'telegram': 'https://t.me/Ch0wdhury_Siam', 'undo': '.undo (reply to the Addon output)'}
