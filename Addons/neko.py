...
ZELRETCH_MODULE_INFO = {'title': 'Neko Media', 'icon': '🐾', 'category': 'Media', 'description': 'Fetches a random neko-themed image.', 'developer': 'Siam Chowdhury', 'github': 'https://github.com/ChowdhurySiam', 'telegram': 'https://t.me/Ch0wdhury_Siam', 'undo': '.undo (reply to the Addon output)'}
