...
"""
ZELRETCH_MODULE_INFO = {'title': 'Username Search', 'icon': '🕵️', 'category': 'Information', 'description': 'Checks a username or identifier across supported public services.', 'developer': 'Siam Chowdhury', 'github': 'https://github.com/ChowdhurySiam', 'telegram': 'https://t.me/Ch0wdhury_Siam', 'undo': '.undo (reply to the Addon output)'}
import asyncio
