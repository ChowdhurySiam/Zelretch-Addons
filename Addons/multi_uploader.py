"""Zelretch Addon: Multi Uploader

Uploads replied files to multiple temporary file-hosting services.
...
@Client.on_message(zel_command("catbox", "Uploader", os.path.basename(__file__)) & zel_sudo())
...
@Client.on_message(zel_command("envs", "Uploader", os.path.basename(__file__)) & zel_sudo())
...
@Client.on_message(zel_command("kappa", "Uploader", os.path.basename(__file__)) & zel_sudo())
...
@Client.on_message(zel_command("0x0", "Uploader", os.path.basename(__file__)) & zel_sudo())
...
@Client.on_message(zel_command("x0", "Uploader", os.path.basename(__file__)) & zel_sudo())
...
@Client.on_message(zel_command("tmpfiles", "Uploader", os.path.basename(__file__)) & zel_sudo())
...
@Client.on_message(zel_command("pomf", "Uploader", os.path.basename(__file__)) & zel_sudo())
...
@Client.on_message(zel_command("bash", "Uploader", os.path.basename(__file__)) & zel_sudo())
