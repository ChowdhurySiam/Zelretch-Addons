"""Zelretch Addon: Adult Media Search

Searches an adult-content provider by tags; use only where lawful and appropriate.
...
ZELRETCH_MODULE_INFO = {'title': 'Adult Media Search', 'icon': '🔞', 'category': 'Restricted Tools', 'description': 'Searches an adult-content provider by tags; use only where lawful and appropriate.', 'developer': 'Siam Chowdhury', 'github': 'https://github.com/ChowdhurySiam', 'telegram': 'https://t.me/Ch0wdhury_Siam'}
...
@Client.on_message(zel_command("rule34", "Rule34", os.path.basename(__file__), "[tags]") & zel_sudo())
