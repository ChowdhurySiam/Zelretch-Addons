...
ZELRETCH_MODULE_INFO = {'title': 'Progress Animation', 'icon': '📊', 'category': 'Fun', 'description': 'Displays an animated progress bar with optional custom text.', 'developer': 'Siam Chowdhury', 'github': 'https://github.com/ChowdhurySiam', 'telegram': 'https://t.me/Ch0wdhury_Siam'}
