...
ZELRETCH_MODULE_INFO = {'title': 'Public OSINT Lookup', 'icon': '🔎', 'category': 'Information', 'description': 'Queries supported public OSINT sources for a supplied phone number.', 'developer': 'Siam Chowdhury', 'github': 'https://github.com/ChowdhurySiam', 'telegram': 'https://t.me/Ch0wdhury_Siam'}
