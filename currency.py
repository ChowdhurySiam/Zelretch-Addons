"""Zelretch Addon: Currency Converter

Converts amounts between configured currencies using current exchange data.
...
ZELRETCH_MODULE_INFO = {'title': 'Currency Converter', 'icon': '💱', 'category': 'Information', 'description': 'Converts amounts between configured currencies using current exchange data.', 'developer': 'Siam Chowdhury', 'github': 'https://github.com/ChowdhurySiam', 'telegram': 'https://t.me/Ch0wdhury_Siam'}
...
@Client.on_message(zel_command("cr", Module_Name, filename, "[amount] [currency]") & zel_sudo())
...
@Client.on_message(zel_command("currency_config", Module_Name, filename, "[currencies]") & zel_sudo())
