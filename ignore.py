...
ZELRETCH_MODULE_INFO = {'title': 'Ignore User', 'icon': '🙈', 'category': 'Administration', 'description': 'Suppresses selected incoming messages from a specified user or chat.', 'developer': 'Siam Chowdhury', 'github': 'https://github.com/ChowdhurySiam', 'telegram': 'https://t.me/Ch0wdhury_Siam'}
