...
ZELRETCH_MODULE_INFO = {'title': 'Weather', 'icon': '🌦️', 'category': 'Information', 'description': 'Shows a text forecast and weather image for a city.', 'developer': 'Siam Chowdhury', 'github': 'https://github.com/ChowdhurySiam', 'telegram': 'https://t.me/Ch0wdhury_Siam'}
